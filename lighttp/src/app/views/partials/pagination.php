...
<div class="pagination-wrap">
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <li<?php if ($currentPage <= 1) echo ' class="disabled"'; ?>>
                ...
                <a href="<?php echo $baseUrl . 'page=' . $prev; ?>" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
                <?php else: ?>
            ...
            <li<?php if ($currentPage >= $totalPages) echo ' class="disabled"'; ?>>
                ...
                <a href="<?php echo $baseUrl . 'page=' . $next; ?>" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
                <?php else: ?>
    ...
    <div class="pagination-info">
        <?php echo $total; ?> items, Page <?php echo $currentPage; ?> of <?php echo $totalPages; ?>
    </div>
</div>